...
export default function GamingPage({ payloadCategoryPage = null }) {
  return <CategoryPage slug="gaming" payloadCategoryPage={payloadCategoryPage} />;
}
...
export async function getServerSideProps() {
  ...
  return {
    props: {
      payloadCategoryPage: await getPayloadCategoryPage("gaming"),
    },
  };
}
