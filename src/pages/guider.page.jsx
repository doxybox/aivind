...
export default function GuiderPage({ payloadCategoryPage = null }) {
  return <CategoryPage slug="guider" payloadCategoryPage={payloadCategoryPage} />;
}
...
export async function getServerSideProps() {
  ...
  return {
    props: {
      payloadCategoryPage: await getPayloadCategoryPage("guider"),
    },
  };
}
