...
- Public app: Next.js 15.5.20, Payload 3.86.0.
- Payload Admin: Next.js 16.2.10, Payload 3.86.0.
- Both applications install deterministically with their own `package-lock.json`.
- Root audit: 0 critical, 0 high, 8 moderate.
- Payload Admin audit: 0 critical, 0 high, 8 moderate, 1 low.

The dependency versions and narrow npm overrides were transferred from the
previously verified `aivind-tech-pulse` reference repository. No audit force-fix
was used.

## Dependency hardening

The public app was moved from Next.js 14.2.35 to 15.5.20 and Payload packages
were aligned on 3.86.0. Lodash and PostCSS were updated. Narrow overrides pin
patched releases of DOMPurify, flatted, form-data, minimatch,
...
Payload Admin was aligned on Payload 3.86.0 and Next.js 16.2.10. The public app
...
PostCSS, and Drizzle tooling findings. There are no critical or high findings,
and npm does not currently offer a compatible zero-risk fix for every chain.
