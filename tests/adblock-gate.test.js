...
test("adblock gate is global and only checks for blockers after advertising consent", () => {
  ...
  assert.match(gate, /useCookieConsent/);
  assert.match(gate, /!consent\.advertising/);
